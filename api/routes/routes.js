...
router.post('/enviarInvitacion', middleware.usuarioNoCandidatoAdminModeradorOMiembro, salaController.invitacion);
...
router.post('/enviarSolicitudContacto', middleware.checkSonContactos ,contactoController.enviarSolicitudContacto);
